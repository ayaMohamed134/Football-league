...
import com.aya.footballleague.DataManager.Remote.VolleyManager.VolleyNetwork.HttpError;
import com.aya.footballleague.DataManager.Remote.VolleyManager.VolleyNetwork.HttpGet;
import com.aya.footballleague.DataManager.Remote.VolleyManager.VolleyNetwork.HttpListener;
import com.aya.footballleague.DataManager.Remote.VolleyManager.VolleyNetwork.HttpPost;
...
public class VolleyInterActor implements IVolleyInterActor {
    ...
    /*
     * this header without Auth
     * @param null
     * @return map of header
     */

    @Override
    public HashMap<String, String> NormalHeader() {
        HashMap map = new HashMap();
        map.put(VolleyInterActor.CONTENT_TYPE, "application/json");
        //map.put(VolleyInterActor.AUTH, "No_Auth");
